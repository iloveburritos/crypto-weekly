...
const Navbar = () => {
  return (
    <nav className="sticky bg-FAF9F6 top-0 max-w-[680px] p-4 flex flex-col sm:flex-row justify-between items-center m-auto text-link pb-3 border-b-2 mb-3  border-border bg-[#FAF9F6] z-10">
      ...
      <div className="order-1 sm:order-2 flex gap-5 justify-center sm:justify-end w-full sm:w-auto">
        <Link className="hover:underline" href="/about">About</Link>
        <Link className="hover:underline" href="/posts">Archive</Link>
