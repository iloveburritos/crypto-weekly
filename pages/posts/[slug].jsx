        ...
        <>
          ...
          <div className="max-w-[680px] mx-auto px-4 py-8">
            ...
            <div className="mb-8">
              ...
              {/* Top Navigation */}
              <nav className="flex justify-between items-center mb-6 pb-4 border-b border-gray-200">
                  ...
                  {prevPost && (
                    ...
                    >
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-sm font-medium">{prevPost.longdate}</div>
                      </div>
                    </Link>
                  )}
                </div>
                  ...
                  {nextPost && (
                    ...
                    >
                      <div className="text-right">
                        ...
                        <div className="text-sm font-medium">{nextPost.longdate}</div>
                      </div>
